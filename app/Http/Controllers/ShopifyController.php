...
// dd($products);
    ...
    public function getTheme(Request $request){
        ...
        if ($response['errors']) {
            ...
            $content = str_replace('data-href="{{ product.url | within: collection }}"', 'data-href="{{ product.url | within: collection }}?location={{ location }}&no_station={{ no_station }}&day={{ day_name }}&uuid={{ uuid }}"', $content);
            $content = str_replace('data-href="{{ product.url }}"', 'data-href="{{ product.url }}?location={{ location }}&no_station={{ no_station }}&day={{ day_name }}&uuid={{ uuid }}"', $content);
