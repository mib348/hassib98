...
// Voucher product pages do not use the menu date/location/uuid flow.
// The hidden _voucher_flow property is rendered by snippets/buy-buttons.liquid,
// so this JS can recognize the standalone voucher page without hardcoding a product URL.
...
function shouldSkipOrderSessionValidation(item) {
  ...
  // Voucher, Pfand and snacks lines do not belong to the date/location menu session.
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  $(document).on("click", "#checkout", function (e) {
    ...
    $.ajax({
      ...
      success: function (cart) {
        ...
        const nonSnacksItems = orderSessionItems.filter(function (item) {
  ...
  // Check if required menu-order parameters are missing and redirect accordingly.
  // Voucher-only carts are intentionally excluded because vouchers do not use a date/location session.
...
if (window.jQuery) {
  ...
  $(document).on("submit", "#cart-notification-form", function (e) {
    ...
    // Menu products must pass cart validation first; voucher-only carts can go straight to Shopify checkout.
